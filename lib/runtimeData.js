const runtimeData = (function () {
    ...
    return {
        ...
        // File references.
        buildURL: "bin",
        loaderURL: "bin/Clicker_Web_VKontakte.loader.js",
        dataURL: "bin/Clicker_Web_VKontakte.data.unityweb",
        frameworkURL: "bin/Clicker_Web_VKontakte.framework.js.unityweb",
        workerURL: "",
        codeURL: "bin/Clicker_Web_VKontakte.wasm.unityweb",
        symbolsURL: "",
